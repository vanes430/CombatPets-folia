...
curl -L -o libs/CommandAPI-10.1.0-mod.jar https://github.com/ArcanePlugins/LevelledMobs/raw/refs/heads/master/levelledmobs-plugin/lib/CommandAPI-10.1.0-mod.jar

# Install CommandAPI to local Maven repository
echo "Installing CommandAPI to local Maven repository..."
mvn install:install-file -Dfile=libs/CommandAPI-10.1.0-mod.jar -DgroupId=nomaven -DartifactId=CommandAPI -Dversion=10.1.0-mod -Dpackaging=jar
